	...
	<div class="container">
		<div class="row">
			<div class="col-md-4">
					...
					<a href="duty.jsp"><button type="button" class="btn btn-primary" style="Height:50px;"data-toggle="modal" data-target="#guards">
					  Guards On Duty
					</button></a>
					...
					<table class="table table-bordered table-striped table-hover" style="margin-left:150px">
					 ...
					 try{
						 ...
						 String url="jdbc:mysql://localhost:3306/COMP390";
							...
							if(query!=null){
								data="SELECT * from complains where number like '%"+query+"%' or your_regno like '%"+query+"%'or date_of_occurrence like '%"+query+"%' or reporting_date like '%"+query+"%' or remarks like'%"+query+"%'";
							}
							else{
